...
```bash
python3 scripts/install_skills.py --mode home --skill skill-creator --skill git-clean-merged-branches --skill mb-domain-driven-design
```
...
```bash
python3 scripts/install_skills.py --mode repo --repo-path /path/to/target-repo --skill git-clean-merged-branches --skill mb-domain-driven-design
```
