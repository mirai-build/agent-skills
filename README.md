...
```bash
python3 scripts/install_skills.py --mode home --skill skill-creator --skill mb-git-clean-branches --skill mb-git-rebase --skill mb-ddd-architect --skill mb-ddd-architect-qa --skill mb-ddd-architect-reviewer --skill mb-ddd-backend-engineer --skill mb-react-fda-engineer --skill mb-implementation-qa --skill mb-code-quality-checker --skill mb-repo-quality-reviewer
```
...
```bash
python3 scripts/install_skills.py --mode repo --repo-path /path/to/target-repo --skill skill-creator --skill mb-git-clean-branches --skill mb-git-rebase --skill mb-ddd-architect --skill mb-ddd-architect-qa --skill mb-ddd-architect-reviewer --skill mb-ddd-backend-engineer --skill mb-react-fda-engineer --skill mb-implementation-qa --skill mb-code-quality-checker --skill mb-repo-quality-reviewer
```
